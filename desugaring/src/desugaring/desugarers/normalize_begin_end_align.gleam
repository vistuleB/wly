...
import desugaring/core.{type Desugarer, Desugarer, type DesugarerTransform, type DesugaringError, type LatexDelimiterPair, DoubleDollar} as core
...
type Param =
  #(core.LatexDelimiterPair, List(LatexDelimiterPair))
