...
/// they already have another specified class.
...
type InnerParam {
  InnerParam(parent_tag: String, class_name: String, selector: String)
}
...
fn inner_param_to_transform(inner: InnerParam) -> DesugarerTransform {
  append_class_to_child_if.constructor(
    #(inner.parent_tag, inner.class_name, core.is_v_and_has_class(
      _,
      inner.selector,
    )),
  ).transform
