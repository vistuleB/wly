...
fn at_root(root: VXML) -> Result(VXML, DesugaringError) {
  ...
  let appendices = infra.v_children_with_tag(root, "Appendix")
  ...
  let other_children = list.filter(children, fn(c) { !infra.is_v_and_tag_is_one_of(c, ["TOC", "Chapter", "Bootcamp", "Appendix"]) })
